...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/level3/book-page/book-page_files/libs.min.css">
    <link rel="stylesheet" href="http://localhost/level3/book-page/book-page_files/style.css">
                ...
                <div id="id" book-id="22">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 info">
                        <div class="bookInfo col-md-12">
                            <div id="title" class="titleBook">{titleBook}</div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="bookLastInfo">
                                <div class="bookRow"><span class="properties">автор:</span><span id="author">{author}</span></div>
                        ...
                        <script>
                            $('.btnBookID').click(function(event) {
                                $.post("http://localhost/level3/book/wants/{id}",
                                {
                                  id: {id}
                                },
                                function(data,status){
                                  var values = parseInt($("#wants").text());
                                  $("#wants").text(values+parseInt(data));
                                });
                            });
                        </script>
                    ...
                    <div class="container">
                        ...
                        <div class="bookRow"><span class="properties">Захотели:</span><span id="wants">{wants}</span></div>
                    </div>
                </div>
            </div>
        </div>
